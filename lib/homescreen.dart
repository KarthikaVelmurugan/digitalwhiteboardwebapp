...
String email;
  ...
  Firestore.instance.collection('qrcode').document(ran).setData({'no':ran,'email':'0','live':false});
...
void initState(){
  ...
  Widget build(BuildContext context){
     ...
     Firestore.instance.collection('qrcode').document(ran).snapshots().listen((event) {
    ...
    return MaterialApp(
      ...
      appBar: AppBar(
        ...
        title: Text("Online WhiteBoard",style:TextStyle(color: Colors.red,fontWeight:FontWeight.bold,fontSize: wt/40) ,),
         ...
         Container(
          ...
          width: wt/5,
            ...
            Padding(
              ...
              child:
            Text("Scan this QR to make\n Collaboration in your app",style:ts1.copyWith(fontSize:wt/70),
                 ), ),
 ...
 Navigator.push(
                ...
                Center(
                 child: Container(
                    ...
                    height:ht/1.25,
                    width: wt/1.3,
                    child: WhiteBoardStream(random: ran,),/* live ? Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children:<Widget>[
                      ...
                      Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children:<Widget>[Image.asset('assets/scan.jpg',color: Colors.black26,height: ht/13,width: wt/15,),
                      Text("No subscribers")]))
                      ), */
